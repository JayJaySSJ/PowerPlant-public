...
namespace PowerPlant.Wcf.Client
{
    internal class ReadingsHandler
    {
        ...
        {
            _readingsManagementClient.UpdateTime(DateTime.Now);
        ...
        {
            var newDataSet = _readingsManagementClient.GetNewDataSetAsync().Result;
            ...
            if (newDataSet != null && newDataSet.CauldronsData != null && newDataSet.TurbinesData != null && newDataSet.TransformatorsData != null)
            {
                ...
                Console.WriteLine("Receival time: " + _readingsManagementClient.GetReadingTimeAsync().Result.ToString());
        ...
        {
            var dataSets = _readingsManagementClient.GetPowerDataSetAsync().Result;
            var totalEnergy = 0d;
        ...
        public void PrintChosenCriticalReadings()
        {
            ...
            var dataSets = _readingsManagementClient.GetCriticalReadingsAsync(floorValue, ceilingValue).Result;
        ...
        public void PrintChosenCriticalStatistics()
        {
            ...
            var dataSets = _readingsManagementClient.GetCriticalStatisticsAsync(floorValue, ceilingValue).Result;
