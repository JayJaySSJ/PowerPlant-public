...
namespace PowerPlant.Wcf.Client
{
    internal class ActionHandler
    {
        ...
        {
            _membersManagementClient.UpdateLoggedMemberAsync(login);
            var loggedMember = _membersManagementClient.GetAsync(login).Result;
                ...
                while (!exit)
                {
                    ...
                    switch (switcher)
                    {
                        ...
                        case 4:
                            ...
                            break;
                        case 5:
                            _serializationHandler.SerializeCriticalReadingsToJsonAsync();
                            break;
                        case 6:
                        ...
                        case 7:
                            ...
                            break;
                        case 8:
                            _inspectionsHandler.CreateNewInspectionTicketAsync(loggedMember);
                            break;
                        case 9:
